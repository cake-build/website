...
**_§2.1_** **Do** reference the lowest version of Cake with API compatibility to the latest version (currently `3.0.0`).
...
**_§2.2_** **Do** reference a newer version than Cake `3.0.0` if the module requires a specific functionality.
...
**_§2.6_** **Avoid** targeting additional frameworks such as `net7.0`.
