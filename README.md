...
This is an Amazing Cake website. It's a static build generated by [Wyam](http://wyam.io) which is hosted on Azure. Wyam is a static content toolkit which can be used to generate web sites, produce documentation, create ebooks, and much more stuff.

## Contributing

Any contributions to repo are appreciated, no matter how big or small. The Cake site consists of several different sections and each one is described below.
