...
Any contributions will be appreciated, no matter how big or small. This Cake site consists of several different sections and each one is described below.
...
The format of an addin file looks like:
